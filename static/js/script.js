    ...
    async fillTodosList(todos) {
        for (const todo of todos) {
            ...
            if(todoItem)
            {
                ...
                button_cha.classList.add('btn-outline-primary');
                button_cha.classList.add('btn-outline-sm');
                ...
                button_rem.classList.add('btn-outline-sm');
                ...
                <div class="modal fade" id="edit-todo-window${id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <button type="button" class="btn btn-outline-dark" data-dismiss="modal"> <b>Отмена</b></button>
                        <button type="button" class="btn btn-outline-primary" id='save-todo-edit${id}'><b>Сохранить</b></button>
                        </div>
                    </div>
                    </div>
                </div>
